...
public class ProductGroupTable extends BaseColumn{
	...
	public static final String COLUMN_PRODUCT_GROUP_NAME3 = "product_group_name_3";
	...
	private static final String SQL_CREATE =
			...
			+ ProductTable.COLUMN_PRODUCT_GROUP_ID + " integer not null, "
			...
			+ COLUMN_PRODUCT_GROUP_NAME3 + " text, " 
